...
export default function SixplexClient({ generatedAt, confirmed, review }: { generatedAt: string; confirmed: Prospect[]; review: Prospect[] }) {
  ...
  return <div className="six-shell">
    <aside className="sidebar"><div><div className="logo"><span>PE</span><div>Property<br/>Extraction</div></div><nav><a href="/">Fourplex prospects</a><a href="/off-market">Off-market candidates</a><a className="active" href="/sixplexes">Sixplex prospects</a><a href="/garages">Garage deals</a><a href="/rankings">Deal rankings</a><a href="/analyze">Buy Lab</a><a href="/flexmls">Flexmls</a></nav></div><form action="/api/logout" method="post"><button className="logout">Sign out</button></form></aside>
