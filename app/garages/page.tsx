...
export default async function GarageDealsPage() {
  ...
  return <div className="garage-shell">
    <aside className="sidebar"><div><div className="logo"><span>PE</span><div>Property<br/>Extraction</div></div><nav><a href="/">Fourplex prospects</a><a href="/off-market">Off-market candidates</a><a href="/sixplexes">Sixplex prospects</a><a className="active" href="/garages">Garage deals</a><a href="/rankings">Deal rankings</a><a href="/analyze">Buy Lab</a></nav></div><form action="/api/logout" method="post"><button className="logout">Sign out</button></form></aside>
