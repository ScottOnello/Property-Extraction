...
export default function OffMarketClient({ candidates, generatedAt, municipalFetchedAt, longHeldProperties, activeListingRows, activeAddressMatchesExcluded }: OffMarketData) {
  ...
  return <div className="off-shell">
    <aside className="sidebar"><div><div className="logo"><span>PE</span><div>Property<br/>Extraction</div></div><nav><a href="/browse">Browse deals</a><a href="/">Fourplex prospects</a><a className="active" href="/off-market">Off-market candidates</a><a href="/off-market/garage-audit">Visual garage audit</a><a href="/sixplexes">Sixplex prospects</a><a href="/garages">Garage deals</a><a href="/rankings">Deal rankings</a><a href="/analyze">Buy Lab</a><a href="/flexmls">Flexmls</a><a href="#method">Screening method</a></nav></div><form action="/api/logout" method="post"><button className="logout">Sign out</button></form></aside>
